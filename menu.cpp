...
void Menu::CreateStyle()
{
	...
	_style.WindowPadding = ImVec2(10, 5);                      // Padding within a window
	...
	_style.FramePadding = ImVec2(0, 0);                        // Padding within a framed rectangle (used by most widgets)
	_style.FrameRounding = 1.0f;                                // Radius of frame corners rounding. Set to 0.0f to have rectangular frames (used by most widgets).
	...
	_style.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.12f, 0.12f, 0.12f, 1.0f);
